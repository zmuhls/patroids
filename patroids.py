"""
Patroids, a NFL-themed offshoot of Asteroids, written & revised in Python

Asteroids by Amin Bandali; Patroids revision by Zach Muhlbauer
...
class GameObject(object):
    ...
    def __init__(self, position, image, speed=4.5):
...
class MyGame(object):
    ...
    def __init__(self):
        ...
        self.soundtrack = load_sound('crowd.wav')
        self.soundtrack.set_volume(.4)
        ...
        self.missile_sound = load_sound('burb.wav')
    ...
    def do_welcome(self):
        ...
        self.welcome_asteroids = self.big_font.render("Patroids",\
                                                True, (255, 215, 0))
        self.welcome_desc =  self.medium_font.render(\
            "Click anywhere to kick-off!", True, (35, 107, 142))
